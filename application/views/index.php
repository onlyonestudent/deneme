...
<html><head>
	...
	<body>
	<div class="kolon div1">
		<h1>HTTP Test Page<br>
			<font size="-1">
				<strong>powered by</strong>
			</font>
			<strong> CWP | CentOS-WebPanel.com</strong>
		</h1>
	</div>
	<div class="kolon div2">
		<form action="<?php echo base_url('kullanici/giris_yap');?>" method="post">
			<button type="submit">Login</button>
		</form>
		<form action="<?php echo base_url('kullanici/giris_yap');?>" method="post">
			<button type="submit">Log in Ammin</button>
		</form>
	</div>
